...
You can use the Python API or command line script to schedule calls, check for new received
calls/sms, or even sync your recorded voicemails/calls.
...
from googlevoice.util import Phone, Message, Folder